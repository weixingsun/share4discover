...
var Login = React.createClass({
  renderLoginButton() {
    if(this.props.user !== null){ // && this.props.user.type ==='gg'){
        return <FIcon name={'google-plus-square'} size={35} backgroundColor="#dddddd" onPress={this._googleSignOut} />
        ...
        return <FIcon name={'google-plus-square'} size={35} backgroundColor="#dd4b39" onPress={this._googleSignIn} />
    }
  },
  renderLoginName() {
