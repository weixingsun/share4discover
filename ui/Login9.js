...
var Login = React.createClass({
  renderLoginGoogle() {
    ...
    //}else 
    if(this.state.user !== null && this.state.user.type ==='gg'){
  ...
  renderLoginFacebook() {
    ...
    if(this.state.user !== null && this.state.user.type !== 'fb'){
      ...
      return (
              <FBLogin
                buttonView={<FBLoginView user={this.state.user} />}
  ...
  componentDidMount() {
    ...
    GoogleSignin.configure({
      ...
      webClientId: '562005031552-0090s2j3muc1mkelqmokg2is1oqahajj.apps.googleusercontent.com',
